...
def get_data_location():
    ...
    if os.path.exists("/content/dataset/dataset_Cropped"):
        data_folder = "/content/dataset/dataset_Cropped"
    else:
...
def download_and_extract(
    url="https://firebasestorage.googleapis.com/v0/b/linkedin-post-generator-bcd8d.appspot.com/o/dataset_Cropped.zip?alt=media&token=ae5f8dba-0ade-4c7a-ab2c-c3059166e95e",
):
    try:
